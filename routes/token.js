...
router.get('/token/:id', async function (req, res, next) {
    try {
        ...
        // checking the cache. comment out until line 31 if you are on localhost. otherwise it will throw errors...
        ...
        // commment out this section if you are working on localhost. otherwise it won't work.
